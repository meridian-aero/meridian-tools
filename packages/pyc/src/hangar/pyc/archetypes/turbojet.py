"""Single-spool turbojet archetype.

Ported from upstream pyCycle example_cycles/simple_turbojet.py.
Elements: fc → inlet → comp → burner → turb → nozz, with shaft and perf.
"""
